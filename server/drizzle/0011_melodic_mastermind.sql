CREATE TABLE `token_blacklist` (
	...
	`created_at` text DEFAULT '2026-07-10T01:05:18.834Z' NOT NULL
);
--> statement-breakpoint
CREATE INDEX `idx_blacklist_token` ON `token_blacklist` (`token`);--> statement-breakpoint
...
CREATE TABLE `__new_comments` (
	...
	`created_at` text DEFAULT '2026-07-10T01:05:18.612Z' NOT NULL,
...
CREATE TABLE `__new_email_verification_codes` (
	...
	`created_at` text DEFAULT '2026-07-10T01:05:18.615Z' NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `__new_instructors` (
	...
	`created_at` text DEFAULT '2026-07-10T01:05:18.608Z' NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `__new_memberships` (
	...
	`expires_at` text,
	`created_at` text DEFAULT '2026-07-10T01:05:18.803Z' NOT NULL,
	FOREIGN KEY (`user_id`) REFERENCES `users`(`id`) ON UPDATE no action ON DELETE no action
);
--> statement-breakpoint
...
CREATE TABLE `__new_orders` (
	...
	`payment_id` text,
	`created_at` text DEFAULT '2026-07-10T01:05:18.800Z' NOT NULL,
	`paid_at` text,
	FOREIGN KEY (`user_id`) REFERENCES `users`(`id`) ON UPDATE no action ON DELETE no action
);
--> statement-breakpoint
...
CREATE TABLE `__new_progress` (
	...
	`completed_at` text,
	`updated_at` text DEFAULT '2026-07-10T01:05:18.795Z' NOT NULL,
...
CREATE TABLE `__new_push_tokens` (
	...
	`updated_at` text DEFAULT '2026-07-10T01:05:18.798Z' NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `__new_room_participants` (
	...
	`joined_at` text DEFAULT '2026-07-10T01:05:18.814Z' NOT NULL,
...
CREATE TABLE `__new_rooms` (
	...
	`created_at` text DEFAULT '2026-07-10T01:05:18.814Z' NOT NULL,
...
CREATE TABLE `__new_sessions` (
	...
	`created_at` text DEFAULT '2026-07-10T01:05:18.805Z' NOT NULL,
	`last_used_at` text,
	FOREIGN KEY (`user_id`) REFERENCES `users`(`id`) ON UPDATE no action ON DELETE cascade
);
--> statement-breakpoint
INSERT INTO `__new_sessions`("id", "user_id", "access_token", "refresh_token", "device_info", "ip_address", "expires_at", "refresh_expires_at", "created_at", "last_used_at") SELECT "id", "user_id", "access_token", "refresh_token", "device_info", "ip_address", "expires_at", "refresh_expires_at", "created_at", "last_used_at" FROM `sessions`;--> statement-breakpoint
DROP TABLE `sessions`;--> statement-breakpoint
ALTER TABLE `__new_sessions` RENAME TO `sessions`;--> statement-breakpoint
CREATE INDEX `idx_sessions_user` ON `sessions` (`user_id`);--> statement-breakpoint
CREATE INDEX `idx_sessions_access_token` ON `sessions` (`access_token`);--> statement-breakpoint
...
CREATE TABLE `__new_users` (
	...
	`wechat_openid` text,
	`avatar_url` text,
	`created_at` text DEFAULT '2026-07-10T01:05:18.598Z' NOT NULL
);
--> statement-breakpoint
