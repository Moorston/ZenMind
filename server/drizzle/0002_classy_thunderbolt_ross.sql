...
CREATE TABLE `__new_courses` (
	...
	`created_at` text DEFAULT '2026-07-08T04:24:23.639Z' NOT NULL,
...
CREATE TABLE `__new_email_verification_codes` (
	...
	`created_at` text DEFAULT '2026-07-08T04:24:23.643Z' NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `__new_instructors` (
	...
	`created_at` text DEFAULT '2026-07-08T04:24:23.633Z' NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `__new_progress` (
	...
	`completed_at` text,
	`updated_at` text DEFAULT '2026-07-08T04:24:23.647Z' NOT NULL,
...
CREATE TABLE `__new_series` (
	...
	`created_at` text DEFAULT '2026-07-08T04:24:23.638Z' NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `__new_users` (
	...
	`created_at` text DEFAULT '2026-07-08T04:24:23.797Z' NOT NULL
);
--> statement-breakpoint
INSERT INTO `__new_users`("id", "email", "password", "nickname", "token", "role", "created_at") SELECT "id", "email", "password", "nickname", "token", "role", "created_at" FROM `users`;--> statement-breakpoint
