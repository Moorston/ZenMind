CREATE TABLE `email_verification_codes` (
	...
	`created_at` text DEFAULT '2026-07-08T03:27:01.175Z' NOT NULL
);
...
CREATE TABLE `users` (
	...
	`token` text,
	`created_at` text DEFAULT '2026-07-08T03:27:01.207Z' NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `__new_courses` (
	...
	`created_at` text DEFAULT '2026-07-08T03:27:01.165Z' NOT NULL,
...
CREATE TABLE `__new_instructors` (
	...
	`created_at` text DEFAULT '2026-07-08T03:27:01.137Z' NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `__new_progress` (
	...
	`completed_at` text,
	`updated_at` text DEFAULT '2026-07-08T03:27:01.202Z' NOT NULL,
...
CREATE TABLE `__new_series` (
	...
	`created_at` text DEFAULT '2026-07-08T03:27:01.164Z' NOT NULL
);
--> statement-breakpoint
