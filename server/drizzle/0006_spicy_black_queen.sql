CREATE TABLE `memberships` (
	...
	`expires_at` text,
	`created_at` text DEFAULT '2026-07-09T06:01:01.065Z' NOT NULL,
...
CREATE TABLE `orders` (
	...
	`payment_id` text,
	`created_at` text DEFAULT '2026-07-09T06:01:01.059Z' NOT NULL,
	`paid_at` text,
	FOREIGN KEY (`user_id`) REFERENCES `users`(`id`) ON UPDATE no action ON DELETE no action
);
--> statement-breakpoint
...
CREATE TABLE `__new_courses` (
	...
	`created_at` text DEFAULT '2026-07-09T06:01:00.607Z' NOT NULL,
...
CREATE TABLE `__new_email_verification_codes` (
	...
	`created_at` text DEFAULT '2026-07-09T06:01:00.610Z' NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `__new_instructors` (
	...
	`created_at` text DEFAULT '2026-07-09T06:01:00.581Z' NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `__new_progress` (
	...
	`completed_at` text,
	`updated_at` text DEFAULT '2026-07-09T06:01:01.043Z' NOT NULL,
...
CREATE TABLE `__new_push_tokens` (
	...
	`updated_at` text DEFAULT '2026-07-09T06:01:01.050Z' NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `__new_series` (
	...
	`created_at` text DEFAULT '2026-07-09T06:01:00.606Z' NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `__new_users` (
	...
	`wechat_openid` text,
	`avatar_url` text,
	`created_at` text DEFAULT '2026-07-09T06:01:01.046Z' NOT NULL
);
--> statement-breakpoint
