...
CREATE TABLE `__new_courses` (
	...
	`created_at` text DEFAULT '2026-07-08T04:49:21.703Z' NOT NULL,
...
CREATE TABLE `__new_email_verification_codes` (
	...
	`created_at` text DEFAULT '2026-07-08T04:49:21.707Z' NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `__new_instructors` (
	...
	`created_at` text DEFAULT '2026-07-08T04:49:21.694Z' NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `__new_progress` (
	...
	`completed_at` text,
	`updated_at` text DEFAULT '2026-07-08T04:49:21.712Z' NOT NULL,
...
CREATE TABLE `__new_series` (
	...
	`created_at` text DEFAULT '2026-07-08T04:49:21.702Z' NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `__new_users` (
	...
	`wechat_openid` text,
	`avatar_url` text,
	`created_at` text DEFAULT '2026-07-08T04:49:21.839Z' NOT NULL
);
--> statement-breakpoint
