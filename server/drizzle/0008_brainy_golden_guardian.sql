CREATE TABLE `room_participants` (
	...
	`joined_at` text DEFAULT '2026-07-09T08:23:39.010Z' NOT NULL,
...
CREATE TABLE `rooms` (
	...
	`created_at` text DEFAULT '2026-07-09T08:23:39.010Z' NOT NULL,
...
CREATE TABLE `__new_comments` (
	...
	`created_at` text DEFAULT '2026-07-09T08:23:38.588Z' NOT NULL,
...
CREATE TABLE `__new_follows` (
	...
	`created_at` text DEFAULT '2026-07-09T08:23:38.589Z' NOT NULL,
...
CREATE TABLE `__new_email_verification_codes` (
	...
	`created_at` text DEFAULT '2026-07-09T08:23:38.594Z' NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `__new_instructors` (
	...
	`created_at` text DEFAULT '2026-07-09T08:23:38.584Z' NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `__new_memberships` (
	...
	`expires_at` text,
	`created_at` text DEFAULT '2026-07-09T08:23:39.002Z' NOT NULL,
	FOREIGN KEY (`user_id`) REFERENCES `users`(`id`) ON UPDATE no action ON DELETE no action
);
--> statement-breakpoint
...
CREATE TABLE `__new_orders` (
	...
	`payment_id` text,
	`created_at` text DEFAULT '2026-07-09T08:23:39.000Z' NOT NULL,
	`paid_at` text,
	FOREIGN KEY (`user_id`) REFERENCES `users`(`id`) ON UPDATE no action ON DELETE no action
);
--> statement-breakpoint
...
CREATE TABLE `__new_progress` (
	...
	`completed_at` text,
	`updated_at` text DEFAULT '2026-07-09T08:23:38.993Z' NOT NULL,
...
CREATE TABLE `__new_push_tokens` (
	...
	`updated_at` text DEFAULT '2026-07-09T08:23:38.996Z' NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `__new_series` (
	...
	`created_at` text DEFAULT '2026-07-09T08:23:38.587Z' NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `__new_users` (
	...
	`wechat_openid` text,
	`avatar_url` text,
	`created_at` text DEFAULT '2026-07-09T08:23:38.569Z' NOT NULL
);
--> statement-breakpoint
