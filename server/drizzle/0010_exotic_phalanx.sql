CREATE TABLE `sessions` (
	...
	`created_at` text DEFAULT '2026-07-10T00:28:35.828Z' NOT NULL,
	`last_used_at` text,
...
CREATE TABLE `__new_comments` (
	...
	`created_at` text DEFAULT '2026-07-10T00:28:35.566Z' NOT NULL,
...
CREATE TABLE `__new_follows` (
	...
	`created_at` text DEFAULT '2026-07-10T00:28:35.567Z' NOT NULL,
...
CREATE TABLE `__new_email_verification_codes` (
	...
	`created_at` text DEFAULT '2026-07-10T00:28:35.569Z' NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `__new_instructors` (
	...
	`created_at` text DEFAULT '2026-07-10T00:28:35.563Z' NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `__new_memberships` (
	...
	`expires_at` text,
	`created_at` text DEFAULT '2026-07-10T00:28:35.819Z' NOT NULL,
	FOREIGN KEY (`user_id`) REFERENCES `users`(`id`) ON UPDATE no action ON DELETE no action
);
--> statement-breakpoint
...
CREATE TABLE `__new_orders` (
	...
	`payment_id` text,
	`created_at` text DEFAULT '2026-07-10T00:28:35.816Z' NOT NULL,
	`paid_at` text,
	FOREIGN KEY (`user_id`) REFERENCES `users`(`id`) ON UPDATE no action ON DELETE no action
);
--> statement-breakpoint
...
CREATE TABLE `__new_progress` (
	...
	`completed_at` text,
	`updated_at` text DEFAULT '2026-07-10T00:28:35.810Z' NOT NULL,
...
CREATE TABLE `__new_push_tokens` (
	...
	`updated_at` text DEFAULT '2026-07-10T00:28:35.813Z' NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `__new_room_participants` (
	...
	`joined_at` text DEFAULT '2026-07-10T00:28:35.831Z' NOT NULL,
...
CREATE TABLE `__new_rooms` (
	...
	`created_at` text DEFAULT '2026-07-10T00:28:35.831Z' NOT NULL,
...
CREATE TABLE `__new_users` (
	...
	`wechat_openid` text,
	`avatar_url` text,
	`created_at` text DEFAULT '2026-07-10T00:28:35.552Z' NOT NULL
);
--> statement-breakpoint
